...
Gawr::Core::Window::Window(uint32_t width, uint32_t height, const char* title, bool resizing) : Context(title)
{
	create_window(width, height, title, resizing);
...
void Gawr::Core::Window::create_window(uint32_t width, uint32_t height, const char* title, bool resizing)
{
...
void Gawr::Core::Window::create_surface()
{
...
void Gawr::Core::Window::create_swapchain()
{
...
void Gawr::Core::Window::create_swapchain_images()
{
...
void Gawr::Core::Window::create_renderpass()
{
	...
	std::vector<VkAttachmentReference> colourAttachments(attachments.size());
	{
...
void Gawr::Core::Window::update_swapchain()
{
